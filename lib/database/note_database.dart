...
''';
  ...
  Future<List<Note>> getAllNotes() async {
    ...
    //   {
    //     'id': 1,
    //     'isImportant': 1, // 1 = true, 0 = false
    //     'number': 100,
    //     'title': 'Belajar Flutter',
    //     'description': 'Mempelajari dasar-dasar Flutter',
    ...
    //     'description': 'Implementasi CRUD di Flutter',
    //     'createdTime': '2024-03-17T08:30:00Z'
    //   },
    // ];

    // Konversi hardcoded data menjadi List<Note>
    // return testData.map((json) => Note.fromJson(json)).toList();
  }
